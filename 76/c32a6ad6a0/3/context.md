...
In `@internal/tool/url_fetch_test.go` around lines 690 - 843, Combine the
repetitive tests (TestURLFetch_AllowlistPermitsMatchingHost,
TestURLFetch_AllowlistBlocksNonMatchingHost,
TestURLFetch_EmptyAllowlistPermitsAll, TestURLFetch_BlocksPrivateIP,
TestURLFetch_BlocksLoopbackIP, TestURLFetch_RedirectToDisallowedHostBlocked)
into a single table-driven test (e.g., TestURLFetch_AllowlistAndIPChecks) using
a []struct{name st...
